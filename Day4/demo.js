...
const host = "https://sof306-97067-default-rtdb.firebaseio.com/";
...
app.controller("myCtrl", function ($scope, $http) {
    ...
    // Hàm tải tất cả sinh viên từ Firebase
    $scope.load_all = function () {
        var url = `${host}students.json`; // Đường dẫn API để lấy danh sách sinh viên
    ...
    $scope.create = function () {
        ...
        var url = `${host}students.json`; // Đường dẫn API để tạo sinh viên mới
    ...
    $scope.update = function () {
        ...
        var url = `${host}students/${$scope.key}.json`; // Đường dẫn API để cập nhật sinh viên dựa trên key
    ...
    $scope.delete = function (key) {
        var url = `${host}students/${key}.json`; // Đường dẫn API để xóa sinh viên dựa trên key
    ...
    $scope.edit = function (key) {
        var url = `${host}students/${key}.json`; // Đường dẫn API để lấy thông tin sinh viên dựa trên key
        $http.get(url).then(function (response) {
